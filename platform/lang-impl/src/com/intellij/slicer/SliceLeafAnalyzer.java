...
public class SliceLeafAnalyzer {
  ...
  public Map<SliceNode, Collection<PsiElement>> createMap() {
    return ConcurrentFactoryMap.createMap(k->ContainerUtil.newConcurrentSet(myLeafEquality),
                                          ()->ContainerUtil.newConcurrentMap(ContainerUtil.<SliceNode>identityStrategy()));
  }
